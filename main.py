...
## This code works with ideal square and triangle coordinates
## It is the first working code for roboSketch
...
def main():
    ...
    # Straight Line
    straight_line_read = open("StraightLine.txt", "r")
    ...
    with sm:
        ...
        smach.StateMachine.add("TURN", Turn(new_straight_line, rate, scale_int),
                               transitions={"move_fwd": "FORWARD",
                                            "do_turn": "TURN",
                                            "do_stop": "STOP",
                                            "move_back": "BACKWARD"
